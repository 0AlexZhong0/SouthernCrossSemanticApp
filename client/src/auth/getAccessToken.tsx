...
const getAccessToken = (): Promise<any> => {
  ...
  const api_key: string = process.env.REACT_APP_SANDBOX_USRNAME!; // the username to access the api
  const secret_key: string = process.env.REACT_APP_SANDBOX_PASSWORD!; // corresponding password to access the api
